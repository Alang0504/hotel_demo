...
<body>
<form action="/room/addRoom" method="post" onsubmit="return check()" enctype="multipart/form-data">
    <table width="50%" border=0 align="center">
        ...
        <tr>
            ...
            <td>
                <c:if test="${room.pic!=null}">
                    <img src="/images/${room.pic}" width=100 height=100/>
                    <br/>
                </c:if>
        ...
        <tr>
            <th colspan="2" align="center"><input class="roomButton" type="submit" value="添加"></th>
        </tr>
    </table>
