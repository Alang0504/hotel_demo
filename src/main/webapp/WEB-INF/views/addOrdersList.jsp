...
<div style="width: 500px;height: 300px">
    <form action="/orders/addOrderReserve" method="post">
        <table width="100%">
            <tr>
                <td class="orderProperty">房间类型</td>
                <td class="orderProperty">床型</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" id="hidden_orderPrice" value="${num}">
                    <input style="border: 0;" type="text" id="orderPrice" name="orderPrice" value="${num}" readonly="ture">
                </td>
            </tr>
            <tr>
