    ...
    <script type="text/javascript">
        ...
        function firstPage() {
            ...
            if (pageNum==1){
                ...
                document.roomForm.action="/room/findRoomByExample?pageNum=1";
        ...
        function prePage() {
            ...
            if (pageNum==1){
                ...
                document.roomForm.action="/room/findRoomByExample?pageNum="+pageNum;
                document.roomForm.submit();
            }
        }
        // 下一页
        ...
        function lastPage(last) {
            ...
            if (pageNum==last){
                ...
                document.roomForm.action="/room/findRoomByExample?pageNum="+last;
                document.roomForm.submit();
            }
        }
        // 跳转页
