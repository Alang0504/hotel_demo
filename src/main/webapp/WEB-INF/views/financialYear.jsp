...
<div style="width: 500px;height: 300px;margin: 0px auto 0px;font-size: 25px">
    <form action="/admin/financialYearPage?status=已使用" method="post">
        <table>
            <tr>
                <td>年度</td>
                <td>
                    <select class="financialText" name="year" id="yearSelect">
                    </select>
                </td>
                <td><input class="financialButton" type="submit" value="查询"></td>
            </tr>
        </table >
